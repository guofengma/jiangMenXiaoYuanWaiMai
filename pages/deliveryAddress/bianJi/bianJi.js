...
Page({
  ...
  onLoad: function (options) {
    let that = this;
    console.log("编辑地址 options-->",options);
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        for(var i in list){
          console.log(i);
          if (list[i].seqId == addr.schoolId){
            console.log(i);
            let school = list[i];
            for (var j in list[i].buildList){
              console.log(j);
              if (addr.buildingId == list[i].buildList[j].seqId){
                console.log(i,j);
                that.setData({
                  linker: addr.linker,
                  linkerPhone: addr.linkerPhone,
                  shchoolBuildList: list[i].buildList,
                  showBuild: '',
                  schoolId: list[i].seqId,
  ...
  saveAddr: function () {
    ...
    let seqId = that.data.addr.seqId;
    let isDeft = that.data.addr.isDeft;
